...
<div class="stat-card">
  <form method="POST" action="{{ route('admin.blog-posts.store') }}" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <textarea name="summary" class="form-control" rows="3" placeholder="Brief outline of the blog post to display on list pages..." required>{{ old('summary') }}</textarea>
    ...
    <div class="mb-3">
      ...
      <textarea name="body" class="form-control" rows="12" placeholder="Write full HTML or plain text content here..." required>{{ old('body') }}</textarea>

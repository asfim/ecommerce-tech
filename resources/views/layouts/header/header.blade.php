      ...
      <div class="mega-panel">
        <div class="row g-3">
          <div class="col-4">
            ...
            <div class="mega-list">
              <a href="#"><i class="bi bi-laptop"></i> Laptops</a>
              <a href="#"><i class="bi bi-phone"></i> Mobiles</a>
              <a href="#"><i class="bi bi-headphones"></i> Headphones</a>
              <a href="#"><i class="bi bi-camera"></i> Cameras</a>
            </div>
          </div>
          <div class="col-4">
            <div class="mega-col-title">Fashion</div>
            <div class="mega-list">
              <a href="#"><i class="bi bi-bag-heart"></i> Women's Wear</a>
              <a href="#"><i class="bi bi-person"></i> Men's Wear</a>
              <a href="#"><i class="bi bi-eyeglasses"></i> Accessories</a>
              <a href="#"><i class="bi bi-award"></i> Watches</a>
            </div>
          </div>
          <div class="col-4">
            <div class="mega-feat">
              <img src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=300&q=80" alt="deal">
              <h6>Weekend Deal</h6>
              <p>Up to 40% off electronics</p>
